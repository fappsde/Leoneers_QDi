...
#define ACCEL_RANGE 3 //Select which accelerometer range to use (see the table below) - Default is 0
//	Accelerometer Range
//	0	+/- 2g
//	1	+/- 4g
//	2	+/- 8g
...
//     Accelerometer
#define A_OFF_X -9537.83//19402
#define A_OFF_Y -5982,33//-2692
#define A_OFF_Z -11076.8//-8625
//    Gyroscope
#define G_OFF_X -242.643//-733
#define G_OFF_Y 167.848//433
#define G_OFF_Z -19.4223//-75
...
class MPU6050G2 {
	...
	public:
		MPU6050G2(int8_t addr);
		MPU6050G2(int8_t addr, bool run_update_thread);
		...
		void getOffsets(float *ax_off, float *ay_off, float *az_off, float *gr_off, float *gp_off, float *gy_off,int caltime);
